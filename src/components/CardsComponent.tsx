...
const CardsComponent = ({isDarkMode, setIsDarkMode}: DarkModeProp) => {
    ...
    const lightcardclass: string = 'max-w-sm border-t-4 !bg-lightgrayblue !shadow-none border-facebook border-x-0 border-b-0 light-active !gap-0'
    ...
    const darkcardclass: string = 'max-w-sm border-t-4 !bg-bluecard !shadow-none border-facebook border-x-0 border-b-0 dark-active !gap-0';
    ...
    const lightsmallcard: string = 'max-w-sm !font-inter-bold !bg-lightgrayblue !shadow-none border-0 light-active';
    const lighttext: string = 'text-darkgrayblue col-span-1';
    const lightsmallnum: string = 'col-span-1 text-darkblue text-4xl'
    const darksmallcard: string = 'max-w-sm !font-inter-bold !bg-bluecard !shadow-none border-0 dark-active';
    ...
    return (
        <div className='px-36 w-screen'>
            <div className='grid grid-cols-4 gap-8'>
                ...
                <div className='col-span-1'>
                    <Card theme={customTheme} 
                        className={!isDarkMode ? 'max-w-sm border-t-4 !bg-lightgrayblue !shadow-none border-twitter border-x-0 border-b-0 light-active !gap-0' : 'max-w-sm border-t-4 !bg-bluecard !shadow-none border-twitter border-x-0 border-b-0 dark-active !gap-0'}>
                        <div className='flex justify-center items-center pt-2 gap-2'>
                ...
                <div className='col-span-1'>
                    <Card theme={customTheme} 
                        className={!isDarkMode ? 'max-w-sm border-t-4 !bg-lightgrayblue !shadow-none border-youtube border-x-0 border-b-0 light-active !gap-0' : 'max-w-sm border-t-4 !bg-bluecard !shadow-none border-youtube border-x-0 border-b-0 dark-active !gap-0'}>
                        <div className='flex justify-center items-center pt-2 gap-2'>
