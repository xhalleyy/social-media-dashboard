...
const CardComponent = () => {
    return (
        <div className='grid gap-8 grid-cols-4 mx-auto w-full'>
            <div className='col-span-1' >
                <Card className='border-t-4 !bg-lightgrayblue !shadow-none border-facebook hover:!bg-lighttoggle active:!bg-lighttoggle' sx={{ minWidth: 260 }}>
                    <CardContent>
                        <div className='flex justify-center items-center pt-4 gap-2'>
                            ...
                            <Typography className='!font-inter-bold text-darkbluegray ' sx={{ fontSize: 14 }} color="text.secondary" gutterBottom>
                                @nathanf
                            </Typography>
                        </div>
                        <div className='flex justify-center mt-3'>
                            <Typography className='!font-inter-bold !text-darkblue' variant="h2" component="div">
                                1987
                            </Typography>
                        </div>
                        <div className='flex justify-center'>
                        <Typography className='!font-inter-reg !text-darkgrayblue !tracking-[.28em] '>
                            FOLLOWERS
                        </Typography>
                        ...
                        <Typography className='!font-inter-bold !text-lime'>
            ...
            <div className='col-span-1' >
                <Card className='border-t-4 !bg-lightgrayblue !shadow-none border-twitter hover:!bg-lighttoggle active:!bg-lighttoggle' sx={{ minWidth: 260 }}>
                    <CardContent>
                        <div className='flex justify-center items-center pt-4 gap-2'>
            ...
            <div className='col-span-1' >
                <Card className='border-t-4 !bg-lightgrayblue !shadow-none igborder hover:!bg-lighttoggle active:!bg-lighttoggle' sx={{ minWidth: 260 }}>
                    <CardContent>
                        <div className='flex justify-center items-center pt-4 gap-2'>
            ...
            <div className='col-span-1' >
            <Card className='border-t-4 !bg-lightgrayblue !shadow-none !border-youtube hover:!bg-lighttoggle active:!bg-lighttoggle' sx={{ minWidth: 260 }}>
                    <CardContent>
                        <div className='flex justify-center items-center pt-4 gap-2'>
                        ...
                        <Typography className='!font-inter-bold !text-brightRed'>
                            144 Today
                        </Typography>
                        </div>
                    </CardContent>
