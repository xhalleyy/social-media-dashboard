...
const CardComponent = () => {
    return (
        <div className='px-36'>
            ...
            <div className='gap-8 grid grid-cols-4 items-center'>
                <div className='col-span-1' style={{ width: '264px' }}>
                    <Card className='border-t-4 !bg-lightgrayblue !shadow-none border-facebook hover:!bg-lighttoggle active:!bg-lighttoggle' >
                        <CardContent>
                ...
                <div className='col-span-1' style={{ width: '264px' }}>
                    <Card className='border-t-4 !bg-lightgrayblue !shadow-none border-twitter hover:!bg-lighttoggle active:!bg-lighttoggle' >
                        <CardContent>
                            <div className='flex justify-center items-center pt-4 gap-2'>
                ...
                <div className='col-span-1' style={{ width: '264px' }}>
                    <Card className='border-t-4 !bg-lightgrayblue !shadow-none igborder hover:!bg-lighttoggle active:!bg-lighttoggle' >
                        <CardContent>
                            <div className='flex justify-center items-center pt-4 gap-2'>
                ...
                <div className='col-span-1' style={{ width: '264px' }}>
                    <Card className='border-t-4 !bg-lightgrayblue !shadow-none !border-youtube hover:!bg-lighttoggle active:!bg-lighttoggle' >
                        <CardContent>
                            <div className='flex justify-center items-center pt-4 gap-2'>
